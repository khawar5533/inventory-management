<template>
  <nav id="sidebar" class="sidebar">
          ...
          <!-- img/avatars/avatar.jpg -->
					<img :src="assetPath('admin/assets/img/avatars/avatar.jpg')" class="img-fluid rounded-circle mb-2" alt="Linda Miller" />
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="mang" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class='sidebar-link' @click="$emit('change-component', 'PurchaseOrder')">Purchase Order</li>
